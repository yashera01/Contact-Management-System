from tkinter import *                                                   #Create the GUI application main window.
import sqlite3                                                          #It provides an SQL interface compliant with the DB-API
import tkinter.ttk as ttk
import tkinter.messagebox as tkMessageBox

root = Tk()                                                             #instance  which manages all other components of tkinter 
...
root.resizable(0, 0)
root.config(bg="#b566ff")                                                #to access atributes after its initialization
...
def OnSelected(event):
    ...
    curItem = tree.focus()                                                          # To focus on required changes 
...
def AddNewWindow():
    ...
    width = 400
    height = 300
    screen_width = root.winfo_screenwidth()                         #return width of screen
    screen_height = root.winfo_screenheight()
    ...
    #*************************************LABELS=*************************************
    lbl_title = Label(FormTitle, text="Adding New Contacts", font=('arial', 16), bg="#00ccff",  width = 300)
    lbl_title.pack(fill=X)
    lbl_firstname = Label(ContactForm, text="Firstname", font=('arial', 14), bd=5)
    lbl_firstname.grid(row=0, sticky=W)
    lbl_lastname = Label(ContactForm, text="Lastname", font=('arial', 14), bd=5)
...
#*************************************BUTTONS*************************************
btn_add = Button(MidLeft, text="ADD NEW", bg="#cc6699", command=AddNewWindow)   ##66ff66
btn_add.pack()
btn_delete = Button(MidRight, text="DELETE", bg="#cc6699", command=DeleteData)             #red
